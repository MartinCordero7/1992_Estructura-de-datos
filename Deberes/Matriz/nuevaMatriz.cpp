 ...
 * FECHA CREACION: Miercoles,  13 de noviembre de 2024
 * FECHA MODIFICACION: Miercoles, 13 de noviembre de 2024
...
{
    // Base de la recursión: si estamos en la primera celda
    ...
    if (c > 0)
        ...
        sumaRecursivaMatrices(mat1, mat2, result, f - 1, MAX - 1); // Mover a la última columna de la fila anterior
}
...
int main()
{
    ...
    // Llamada a la función recursiva para llenar la matriz resultante
